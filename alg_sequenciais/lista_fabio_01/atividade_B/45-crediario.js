...
const valor_mercadoria = Number(input('Informe o valor da mercadoria: '))

const valor_distribuido = Math.trunc(valor_mercadoria / 3)
const entrada = valor_distribuido + Math.trunc(valor_mercadoria % 3)

const parcelas_restantes = (valor_mercadoria - entrada) / 2

console.log(`Valor de entrada: R$ ${entrada}\nValor das duas prestações restantes: R$ ${parcelas_restantes}`)

/*console.log(valor_distribuido)
console.log(entrada)
console.log(parcelas_restantes)*/